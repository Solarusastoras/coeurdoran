        ...
        <div className="about-card">
          ...
          <div className="about-content">
            ...
            <div className="about-body">
              ...
              <p>
                Après des soucis de santé et un nouveau départ en France, j’ai choisi de me réinventer à travers ce qui m’anime depuis toujours : la cuisine. C’est ainsi qu’est né Cœur d’Oran : un traiteur oriental éco-responsable, où chaque plat, chaque pièce est fait maison, avec des produits de qualité et une vraie volonté de bien manger.
              </p>
